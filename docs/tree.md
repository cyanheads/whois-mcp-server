...
│   │       └── definitions/
│   │           ├── _fqdn.ts
│   │           ├── whois-check-availability.tool.ts
│   │           ├── whois-get-dns.tool.ts
│   │           ├── whois-get-dossier.tool.ts
│   │           ├── whois-lookup-asn.tool.ts
│   │           ├── whois-lookup-domain.tool.ts
│   │           └── whois-lookup-ip.tool.ts
│   ├── services/
│   │   ├── doh/
│   │   │   ├── doh-service.ts
│   │   │   └── types.ts
